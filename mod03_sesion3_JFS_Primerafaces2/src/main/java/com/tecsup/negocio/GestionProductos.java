...
public class GestionProductos {
	...
	static {
		productosXcategorias.put(new Integer(1), 
					Arrays.asList(new Producto(10,"Smartphone","Smartphone","phone",1),
								  new Producto(11,"Tablet","Tablet","tablet",2)));
		productosXcategorias.put(new Integer(2), 
				Arrays.asList(new Producto(20,"La Casa Verde","La Casa Verde","verde",1),
							  new Producto(21,"El Capitan Grant","El Capitan Grant","capitan",3)));
		productosXcategorias.put(new Integer(3), 
				Arrays.asList(new Producto(30,"Futbol","Futbol","futbol",4),
							  new Producto(31,"Voley","Voley","voley",5)));
